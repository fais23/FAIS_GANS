...
def menu():
  ...
  if mn=="":
    ...
    print('==========================================')
    print('[1]\x1b[0;32m Lihat Hasil Ok')
    print('[2]\x1b[0;33m Lihat Hasil Cp')
    print('[0] Kembali')
    print('==========================================')
    hs = raw_input('[?] Input : ')
    if hs == '':
...
def metode():
    print('[1]\x1b[0;33m Metode mbasic.facebook.com')
    print('[2]\x1b[0;33m Metode mobile.facebook.com')
    print('[3]\x1b[0;33m Metode free.facebook.com')
    md = raw_input('[?] Input : ')
    if md == '':
	exit()
    elif md == '1' or md == '01':
